...
class ServiceOrder extends Model implements HasMedia
{
    ...
    /**
     * generateWorkOrder() se dispara acá para que la Orden de Trabajo se
     * genere sin importar por qué camino el status llega a
     * "presupuesto_aceptado" (incluye cambiarlo a mano desde el admin).
     */
    ...
    /**
     * Habilita "Revisar y presupuestar": necesita un Relevamiento vinculado
     * y que el relevador ya lo haya enviado (submitted_at seteado).
     */
     ...
     * vinculado (si lo hay). Idempotente.
     */
