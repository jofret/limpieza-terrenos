        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('customer_id')
                    ...
                    ->disabled()
                    ->dehydrated(true)
                    ->helperText('Se completa solo a partir del Relevamiento elegido arriba.')
                    ->required(),
                ...
                Forms\Components\Select::make('property_id')
                    ...
                    ->disabled()
                    ->dehydrated(true)
                    ->helperText('Se completa sola a partir del Relevamiento elegido arriba.')
                    ->required(),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('view_budget')
                    ->label('')
                    ->getStateUsing(fn (ServiceOrder $record): ?string => $record->budget_token !== null ? 'Ver presupuesto' : null)
                    ->icon('heroicon-o-document-text')
                    ->color('gray')
                    ->url(fn (ServiceOrder $record): ?string => $record->budget_token ? url('/presupuesto/'.$record->budget_token) : null, shouldOpenInNewTab: true),
