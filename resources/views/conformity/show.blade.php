...
@section('meta_description', 'AltoParque WhatsApp ✅ 11 7178 9529 | Confirmá la conformidad del trabajo realizado.')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="bg-gray-50 border-b border-gray-200 p-6">
            ...
            <p class="text-gray-700"><span class="font-semibold text-gray-800">Propiedad:</span> {{ $order->property?->display_label ?? '—' }}</p>
        </div>
