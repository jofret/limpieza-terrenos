...
class WhatsAppCloudApiService
{
    ...
    /**
     * Envía una imagen ya guardada en el disco público, con un texto
     * opcional como epígrafe. Primero la sube a los servidores de Meta y
     * recién con el media ID que devuelve manda el mensaje.
     */
     ...
     * ID) y la guarda en el disco público. Devuelve la ruta relativa.
     */
