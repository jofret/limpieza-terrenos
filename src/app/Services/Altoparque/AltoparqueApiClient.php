 ...
 *
 * Un único token (ALTOPARQUE_API_TOKEN, del SiteClient
 * "limpieza-y-desmalezado-de-terrenos") alcanza siempre: aunque este sitio
 * reciba mensajes reenviados por el hub de poda-de-altura-v2 (mismo número
 * de WhatsApp compartido), de acá para adentro todo pertenece a este sitio.
 */
class AltoparqueApiClient
{
     ...
     *
     * @return array<int, array{id: int, customer_name: ?string, customer_zone: ?string, post_id: ?int, comment: string, gender: ?string, occupation: ?string, created_at: string}>
     */
